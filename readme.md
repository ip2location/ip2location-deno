...
*Note: this version only supported Deno version 1.30.0+ and v2.x.*
...
To learn more about installation, usage, and code examples, please visit the developer documentation at [https://ip2location-deno.readthedocs.io/en/latest/index.html](https://ip2location-deno.readthedocs.io/en/latest/index.html).